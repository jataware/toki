...
attributes_map: dict[GoogleModelName, Attr] = {
    ...
    "gemini-3.5-flash":                                         Attr(context_size=1048576, supports_tools=True, supports_thinking=True),
    "gemini-3.5-flash-lite":                                    Attr(context_size=1048576, supports_tools=True, supports_thinking=True),
    "gemini-3.6-flash":                                         Attr(context_size=1048576, supports_tools=True, supports_thinking=True),
    "gemini-3.7-flash":                                         Attr(context_size=1048576, supports_tools=True, supports_thinking=True),
